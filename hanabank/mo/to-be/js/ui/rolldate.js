...
(function (global, factory) {
  ...
  Rolldate.prototype = {
    ...
    baseData: function baseData() {
      return {
        ...
        opts: {
          ...
          minStep: 1,
          trigger: 'tap',
          lang: { title: 'Select A Date', cancel: '취소', confirm: '확인', year: '년', month: '월', day: '일', hour: '', min: '', sec: '' }
        }
      };
    },
    ...
    createUI: function createUI() {
      ...
      var $html = '<div class="rolldate-mask"></div>\n            <div class="rolldate-panel">\n                <header>\n                    ' + lang.title + '\n                    <button type="button" class="rolldate-cancel">' + lang.cancel + '</button>\n                    </header>\n                <section class="rolldate-content">\n                    <div class="rolldate-dim mask-top"></div>\n                    <div class="rolldate-dim mask-bottom"></div>\n                    <div class="rolldate-wrapper">\n                        ' + ul + '\n                    </div>\n                </section>\n            <div class="rolldate-btn-area"><button type="button" class="rolldate-confirm">' + lang.confirm + '</button></div>\n                </div>',
    ...
    show: function show() {
      ...
      jQuery('.rolldate-container').fadeIn();
    },
